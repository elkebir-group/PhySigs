...
getSNVMatrix <- function(file_name) {
  ...
  input_mat = read_excel(file_name, sheet = "cleaned_variants", col_types = c("text", "text", "text", "text", "numeric", "text", "text", "numeric"))
...
ind_mat   <- getPhenotypeMatrix("../data/tracerx/appendix_2.xlsx")
tree_mat  <- getTreeMatrix("../data/tracerx/appendix_2.xlsx")
input_mat <- getSNVMatrix("../data/tracerx/appendix_2.xlsx")
